...
<div class="diagnostic-view">
    ...
    <div class="rp-content ">
        ...
        <div class="rp-row g-0">
            ...
            <div class="rp-field" style="width: 213px">
                <div class="rp-field-label">7 - Número da Guia atribuida pela operadora</div>
                <div class="rp-field-value">
        ...
        <div class="rp-row">
            ...
            <div class="rp-field rp-field-p-25" style="width: 301px">
        ...
        <div class="section-title">Dados do Contrato executante</div>
        <div class="rp-row">
            <div class="rp-field rp-field-p-20 ">
        ...
        <div class="rp-row">
            ...
            <div class="rp-field " style="width: 577px">
